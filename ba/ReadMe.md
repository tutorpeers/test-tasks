...
Supplementing the Story with a BPMN diagram would be ideal. It is a part of the specification that helps to avoid repetitive and lengthy statements in the Story.

Please, choose any of the options offered below. We expect people to spend no more than 4 or 5 hours on this, so plan the scope accordingly, but avoid making it trivial.
...
1. Prepare a User Story describing a system that manages promo coupons of different type for a Rock band concert.
...
6. Prepare a User Story describing a freelancer marketplace sign-up process. Consider offering sign up with email and password or with a LinkedIn account.
